...
export default function ForgotPassword() {
  ...
  async function handleStart(e) {
    ...
    setStatus('starting');
    try {
      const { loginToken } = await api.authForgotPassword(phone, newPassword);
  ...
  return (
    <div className="checkout-page">
      ...
      {status === 'starting' && <p className="state-msg">Starting…</p>}

      {status === 'waiting' && (
        <div>
          <p className="state-msg">Confirm it's really you via Telegram to finish resetting your password.</p>
          <a
            href={telegramLink}
            target="_blank"
