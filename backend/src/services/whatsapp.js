...
// Wraps the WhatsApp Business Platform (Cloud API). Set WHATSAPP_TOKEN and
// WHATSAPP_PHONE_NUMBER_ID from Meta's developer console.
...
const TEMPLATES = {
  ...
  item_unavailable: (o) => `Heads up: "${o.itemName}" wasn't available at the shop for order #${o.orderId}. You've been refunded ₦${o.amount} for that item. The rest of your order is still on the way.`,
  refund_issued: (o) => `A refund of ₦${o.amount} has been issued for order #${o.orderId}.`,
...
// notify('order_confirmed', customerPhone, { name, orderId })
